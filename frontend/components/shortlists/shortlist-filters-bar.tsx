...
interface ShortlistFiltersBarProps {
  searchQuery: string;
...
export function ShortlistFiltersBar({
  searchQuery,
  onSearchChange,
  evaluationFilter,
    ...
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between pt-1 border-t border-zinc-100 text-xs text-zinc-500">
        <div>
          ...
          <span className="font-medium text-zinc-700">{totalShortlisted}</span> shortlisted candidates
        </div>
      </div>
    </div>
  );
